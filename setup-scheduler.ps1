...
#   8:15 AM  -- Strategy Agent (AI recommendations)
#   8:20 AM  -- Intel Agent (competitive intelligence)
...
Register-GrantTask "4 Strategy"       "agents/grant-strategy-agent.js"     "8:15AM"  "Strategy Agent (AI recommendations)"
Register-GrantTask "5 Intel"          "agents/grant-intel-agent.js"        "8:20AM"  "Intel Agent (competitive intelligence)"
Register-GrantTask "6 Tests"          "agents/grant-test-runner.js"        "8:30AM"  "Test Runner (data integrity)"
Register-GrantTask "7 Alerts"         "agents/grant-alert-agent.js"        "8:45AM"  "Alert Agent (urgent deadline emails)"
Register-GrantTask "8 Deadlines"      "agents/grant-deadline-monitor.js"   "8:45AM"  "Deadline Monitor (7/14/30-day reminders)"
...
Write-Host "  8:15 AM  -> Strategy Agent (AI recommendations)"
Write-Host "  8:20 AM  -> Intel Agent (competitive intelligence)"
